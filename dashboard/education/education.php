...
// Fetch all content
$result = $db->query("SELECT * FROM education ORDER BY created_at DESC");
$contents = [];
if ($result) {
    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div class="p-6 rounded-xl bg-white shadow-lg transition-shadow duration-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Education</h2>
                    <p class="text-gray-600 text-sm sm:text-base">Manage and organize your education content efficiently
                    </p>
                </div>
            ...
            <div class="relative shadow-md sm:rounded-lg overflow-x-auto md:overflow-visible">
                <table class="min-w-full text-sm text-left text-gray-600">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-4 whitespace-nowrap md:whitespace-normal">Video</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 bg-white hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <video class="w-40 h-24 object-cover rounded-lg" controls>
                                    <source
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="video"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">MP4, WebM or MOV (MAX.
                                                100MB)</p>
                                        </div>
                                ...
                                <div id="video-preview" class="mt-4 hidden">
                                    <div class="relative inline-block">
                                        <video class="max-w-full h-auto rounded-lg shadow-md" controls>
                    ...
                    <form id="editContentForm" class="p-6 space-y-6 overflow-y-auto" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="edit_video"
                                            ...
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">MP4, WebM or MOV
                                                    (MAX. 100MB)</p>
                                            </div>
                                ...
                                <div id="current_video" class="mt-4">
                                    <div class="relative inline-block">
                                        <video id="current_video_preview" class="max-w-full h-auto rounded-lg shadow-md"
                                            controls>
                                            <source src="" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                        <button type="button" id="change_video_btn"
                                            class="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white rounded-full p-1.5 shadow-lg transition-colors duration-200">
                                            <i class='bx bx-x text-xl'></i>
                                        </button>
                                    </div>
