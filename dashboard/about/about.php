    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div class="p-6 rounded-xl bg-white shadow-lg transition-shadow duration-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">About Content</h2>
                    <p class="text-gray-600 text-sm sm:text-base">Manage and organize your about page content
                        efficiently
                    </p>
                </div>
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="w-full">
                            <div class="aspect-[16/9] w-full overflow-hidden rounded-lg shadow-md">
                                <img src="/dashboard/uploads/about/<?php echo htmlspecialchars($content['image']); ?>"
                        ...
                        <div class="w-full space-y-4">
                            ...
                            <div class="flex gap-3 pt-4">
                                <button type="button"
                                    class="edit-content inline-flex items-center gap-2 text-blue-600 hover:text-blue-500 transition-colors duration-200"
                                ...
                                <button type="button"
                                    class="delete-content inline-flex items-center gap-2 text-red-600 hover:text-red-500 transition-colors duration-200"
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="text" name="text" rows="3"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="Enter content text" required></textarea>
                            </div>
            ...
            <div class="relative w-full max-w-2xl max-h-full overflow-x-hidden overflow-y-auto">
                <div class="relative bg-white rounded-lg shadow-xl max-h-[90vh] flex flex-col">
                    ...
                    <form id="editContentForm" class="p-6 space-y-6 overflow-y-auto" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="edit_title" class="block mb-2 text-sm font-medium text-gray-900">
                                    Title <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label for="edit_text" class="block mb-2 text-sm font-medium text-gray-900">
                                    Text <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label for="edit_description" class="block mb-2 text-sm font-medium text-gray-900">
                                    Description <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label for="edit_image" class="block mb-2 text-sm font-medium text-gray-900">
                                    Image
                                </label>
        ...
        <div id="deleteContentModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-2 sm:p-4 overflow-y-auto md:inset-0 h-full">
            <div class="relative w-full max-w-md mx-auto my-4 sm:my-8">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-3 sm:p-4 border-b rounded-t border-gray-200">
